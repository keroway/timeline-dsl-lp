...
export const en = {
  ...
  "nav.theme.dark": "Dark",
  "nav.menu.open_aria_label": "Open menu",
  "nav.menu.close_aria_label": "Close menu",
  "footer.copyright": "© {years} keroway",
  "footer.links": "Footer navigation",
  "footer.project_links": "Project links",
  "footer.heading.product": "Product",
  ...
  "lp.why.point2.title": "Regenerable from text",
  "lp.why.point2.body":
  ...
  "lp.why.point3.title": "A CLI + WASM that runs anywhere",
  "lp.why.point3.body":
    "The browser Playground and the local CLI share the same validation logic, so wiring it into CI comes naturally.",
  "lp.why.compare.heading": "How it compares to alternatives",
  "lp.why.compare.col.approach": "Approach",
  "lp.why.compare.col.validation": "Validation",
  "lp.why.compare.col.diff": "Diff & review",
  "lp.why.compare.col.output": "Output",
  "lp.why.compare.tdsl.approach": "Timeline DSL",
  "lp.why.compare.tdsl.validation": "Yes (with diagnostics)",
  "lp.why.compare.tdsl.diff": "Git diffs on text",
  "lp.why.compare.tdsl.output": "HTML / SVG / PNG / PDF",
  "lp.why.compare.handdrawn.approach": "Hand-drawn diagram (drawing tool)",
  "lp.why.compare.handdrawn.validation": "None",
  "lp.why.compare.handdrawn.diff": "Image diffs only",
  "lp.why.compare.handdrawn.output": "Image (hard to reuse)",
  "lp.why.compare.spreadsheet.approach": "Spreadsheet",
  "lp.why.compare.spreadsheet.validation": "None",
  "lp.why.compare.spreadsheet.diff": "Hard to track cell by cell",
  "lp.why.compare.spreadsheet.output": "Table (not built for timelines)",
  ...
  "gallery.preview.zoom_btn_aria_label": "Enlarge preview of {title}",
  "gallery.preview_modal.aria_label": "Enlarged preview of {title}",
  ...
  "playground.share.source_too_large":
    "Source is too large to share as a link (limit {limit} bytes after decoding)",
