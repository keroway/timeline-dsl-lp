export const ja = {
  ...
  "gallery.preview.zoom_btn_aria_label": "{title} のプレビューを拡大表示",
  "gallery.preview_modal.aria_label": "{title} の拡大プレビュー",
  "gallery.preview_modal.close_aria_label": "拡大プレビューを閉じる",
