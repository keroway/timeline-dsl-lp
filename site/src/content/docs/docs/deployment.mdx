...
通常は GitHub Release asset から WASM bundle を取得します。`<version>` には適用したい release tag（例: `v1.3.0`）を指定します。最新タグは [Releases ページ](https://github.com/keroway/timeline-dsl/releases) で確認できます。
